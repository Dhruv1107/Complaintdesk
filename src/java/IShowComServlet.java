 ...
 * @author DHRUV
 */
public class IShowComServlet extends HttpServlet {
...
protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      PreparedStatement ps1=conn.prepareStatement("select * from inchargemsg where usr=?");
    ...
    out.println("<P ALIGN='center'><TABLE border=1 width=400 height=150 align=center>");
     ...
     out.println("<TH style='text-align:center'>Change Status</TH>");
      out.println("</TR>"); 
      while (rs.next()) {  
        String msg = rs.getString("msg");
//        out.println(msg);//Full msg is there
